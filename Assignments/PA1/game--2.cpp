...
int considerMoves(int map[][WIDTH], int candidate_moves[][4], int &num_candidate_moves)
{
    ...
    for (int row = 0; row < HEIGHT; row++) // down => up
    {
        ...
        {
            int map_copy[MAX_MOVES][WIDTH];
            bool matches[HEIGHT][WIDTH] = {};
            int score_gained = 0;
            copyMap(map, map_copy, MAX_MOVES);
            ...
            if (score_gained >= max_score_gained)
            {
                ...
                candidate_moves[num_candidate_moves][0] = col;
                candidate_moves[num_candidate_moves][1] = row;
                candidate_moves[num_candidate_moves][2] = col + 1;
                candidate_moves[num_candidate_moves++][3] = row;
                cout << candidate_moves[num_candidate_moves - 1][0] << candidate_moves[num_candidate_moves - 1][1] << candidate_moves[num_candidate_moves - 1][2] << candidate_moves[num_candidate_moves - 1][3] << endl;
            }
        }
    }
    ...
    for (int col = 0; col < WIDTH; col++) // left => right
    {
        for (int row = 0; row < HEIGHT - 1; row++) // down => up
        {
            ...
            if (score_gained >= max_score_gained)
            {
                ...
                candidate_moves[num_candidate_moves][0] = col;
                candidate_moves[num_candidate_moves][1] = row;
                candidate_moves[num_candidate_moves][2] = col;
                candidate_moves[num_candidate_moves][3] = row + 1;
                num_candidate_moves++;
            }
        }
    }
