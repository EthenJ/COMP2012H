...
void GameWidget::mouseMoveEvent(QMouseEvent* event) {
    ...
    } else if (screen_x > width() - 420 || button_group_status == MainWindow::SideMenuStatus::HIDDEN){ // Does handle only if the cursor is on the to-be menu
        int x, y;
